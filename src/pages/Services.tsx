        ...
        <div className="min-h-screen bg-roman-dark text-roman-text font-sans selection:bg-roman-primary selection:text-white">
            ...
            <header className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
                ...
                <div className="container-custom relative z-20">
                    ...
                    >
                        <span className="inline-block py-1 px-3 rounded-full bg-white/5 border border-white/10 text-roman-primary text-sm font-bold tracking-wider mb-6">
                            NUESTROS SERVICIOS
                        </span>
                        ...
                        <p className="text-xl text-roman-muted leading-relaxed">
                    ...
                    >
                        {services.map((service) => (
                            <motion.div
                                ...
                                className={`group relative p-8 rounded-2xl bg-roman-card border border-white/5 hover:border-white/10 transition-all duration-500 hover:shadow-2xl hover:shadow-roman-primary/5 cursor-default overflow-hidden`}
                            >
                                ...
                                <div className="relative z-10">
                                    <div className={`w-14 h-14 rounded-xl flex items-center justify-center mb-6 bg-roman-dark border border-white/10 ${service.color} group-hover:scale-110 transition-transform duration-500`}>
                                        {service.icon}
                                    </div>

                                    <h3 className="text-2xl font-bold text-white mb-4 font-display">{service.title}</h3>
                                    <p className="text-roman-muted mb-8 leading-relaxed text-sm">
                                        {service.description}
                                    </p>
                                    ...
                                    <div className="mt-8 pt-6 border-t border-white/5 flex items-center justify-between">
                                        <span className="text-xs font-mono text-roman-muted uppercase tracking-wider">Servicio Profesional</span>
            ...
            <section className="py-32 relative overflow-hidden">
                ...
                <div className="container-custom relative z-10 text-center">
                    <h2 className="text-4xl md:text-5xl font-bold font-display text-white mb-8">¿Listo para mejorar tu vehículo?</h2>
                    <p className="text-xl text-roman-muted mb-10 max-w-2xl mx-auto">
                    ...
                    <a
                        ...
                        className="inline-flex items-center justify-center px-8 py-4 bg-roman-primary text-white font-bold rounded-full hover:bg-blue-600 transition-all duration-300 shadow-[0_0_40px_rgba(37,99,235,0.3)] hover:shadow-[0_0_60px_rgba(37,99,235,0.5)] transform hover:-translate-y-1"
                    >
